...
Русский пакет локализации доступен в [**Packagist**](https://packagist.org/packages/pkgstore/flarum-l10n-russian-core) и может быть установлен при помощи **Composer**.
...
```sh
composer require pkgstore/flarum-l10n-russian-core
```
...
```sh
composer update pkgstore/flarum-l10n-russian-core
...
```sh
composer remove pkgstore/flarum-l10n-russian-core
php flarum cache:clear
```
...
2. [неофициальная](https://github.com/pkgstore/flarum-l10n-russian-core).
